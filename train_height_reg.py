...
parser.add_argument("--hmin_sc", type=float, default=20.)
parser.add_argument("--hmax_sc", type=float, default=70.)
parser.add_argument("--hmin_led", type=float, default=50.)
parser.add_argument("--hmax_led", type=float, default=120.)
parser.add_argument("--led_sc_ratio_min", type=float, default=1.5)
parser.add_argument("--led_sc_ratio_max", type=float, default=3.)
parser.add_argument("--t_increase_ratio", type=float, default=3.)
