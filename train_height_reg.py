...
parser.add_argument("--hmin_sc", type=float, default=5.)
parser.add_argument("--hmax_sc", type=float, default=185.)
parser.add_argument("--hmin_led", type=float, default=40.)
parser.add_argument("--hmax_led", type=float, default=140.)
parser.add_argument("--led_sc_ratio_min", type=float, default=.4)
parser.add_argument("--led_sc_ratio_max", type=float, default=7.)
